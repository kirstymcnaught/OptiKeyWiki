...
*Both of these features are turned ON by default, but can be toggled on or off from the 'Words' tab of the Management Console. See [Words settings](https://github.com/JuliusSweetland/OptiKey/wiki/Word-settings) for more.*